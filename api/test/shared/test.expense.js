...
describe('Expense', () => {
    ...
    describe('new Expense', () => {
        it('creates an instance of Expense', () => {
            expect(expense instanceof Expense).to.equal(true);
        });
    });
    ...
    describe('expense.addAmount', () => {
       it('adds amount correctly', () => {
           expense.addAmount(5);
           expect(expense.amount).to.equal(28.45);
       });
    });

    describe('Expense.sumExpenses', () => {
        it('is a Function', () => {
            expect(Expense.sumExpenses).to.be.a('Function');
        });
        ...
        it('sums a person (Adriana) for expenses correctly ($53.54)', () => {
            expect(_.find(summed.people, { name: 'Adriana' }).amount).to.equal(53.54);
        });
    });
});